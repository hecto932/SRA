  		 	...
  		 	<div class="row">
        		<div class="col s12 m12 l12 ">
        			<div class="card">
        				...
        				<form id="form_nuevoUsuario" class="col s12" action="empleado/empleadoNuevo" method="POST" enctype="multipart/form-data">
        				<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
					      <div class="row">
					        ...
					        <div class="input-field col s6">
					          <input id="first_name" type="number" class="validate" name="cedula" value="<?php echo set_value('cedula'); ?>">
